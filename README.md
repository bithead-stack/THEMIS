...
BAI-Net26 is included through Git LFS. Source links for four externally hosted datasets are listed in [dataset/DATASETS.md](dataset/DATASETS.md). Use `--dataset` to select a dataset and `--data_dir` to provide its local path.
